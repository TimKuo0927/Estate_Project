...
function Button({
  ...
  if (variant === 'secondary') variantClass = 'bg-gray-700 hover:bg-gray-900 text-white';
  if (variant === 'danger') variantClass = 'bg-red-500 hover:bg-red-700 text-white';
  if (variant === 'outline')
    variantClass =
      'bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white hover:border-transparent';
